...
export type GetOrderQuery = { __typename?: 'Query', getOrder: { __typename?: 'Order', id: number, amount: number, status: string, trackingLink?: string | null, lineItems: Array<{ __typename?: 'OrderLineItem', id: number, skuId: string, price: number, costPrice: number, quantity: number }> } };
